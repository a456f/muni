    ...
    <aside className="sidebar">
      ...
      <nav className="sidebar-menu">
        ...
        <button 
          ...
          className={activeTab === 'denuncias' ? 'active' : ''}
        >
        ...
        <button 
          onClick={() => setActiveTab('serenazgo')} 
          className={activeTab === 'serenazgo' ? 'active' : ''}
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path></svg>
          Serenazgo
        </button>
        <button 
          onClick={() => setActiveTab('patrullaje')} 
          className={activeTab === 'patrullaje' ? 'active' : ''}
        >
        ...
        <button 
          ...
          className={activeTab === 'almacen' ? 'active' : ''}
        >
        ...
        <button 
          ...
          className={activeTab === 'geografia' ? 'active' : ''}
        >
